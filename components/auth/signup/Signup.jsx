...
const SignUp = ({ navigation }) => {
    ...
    const handleSignUp = async () => {
        ...
        // 4. Mobile validation
        if (mobile.length !== 10) {
            Alert.alert('Mobile Error', 'Mobile number must be 10 digits.');
            return;
        }
        ...
        try {
            ...
            if (!response.ok) {
                ...
                Alert.alert('Registration Error', errorData.message || `Server error: ${response.status}`);
                return;
            }
            ...
            if (data.success) {
                Alert.alert(
                    ...
                    `Account created successfully for ${name} as a ${role}. You can now sign in.`,
                    [
                        {
                            text: 'OK',
                ...
                Alert.alert('Registration Error', data.message || 'Error creating account. Please try again.');
            }
        } catch (error) {
